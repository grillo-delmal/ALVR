...
pub fn initialize_interaction(
    ...
    let action_set = xr_ctx.instance
    ...
    let (left_hand_tracker, right_hand_tracker) = if xr_ctx.instance.exts().ext_hand_tracking.is_some()
        && xr_ctx.instance.supports_hand_tracking(xr_ctx.system).unwrap()
    {
        (
    ...
    let eye_tracker_fb = (face_tracking_sources
        ...
        && xr_ctx.instance.supports_social_eye_tracking(xr_ctx.system).unwrap())
    ...
    let face_tracker_fb = (face_tracking_sources
        ...
        && xr_ctx.instance.supports_fb_face_tracking(xr_ctx.system).unwrap())
